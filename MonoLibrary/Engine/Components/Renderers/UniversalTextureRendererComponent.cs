...
namespace MonoLibrary.Engine.Components.Renderers
{
    ...
    /// </summary>
    public class UniversalTextureRendererComponent : TextureRendererComponent
    {
        public Vector2? Size { get; set; }

        public UniversalTextureRendererComponent(GameObject owner) : base(owner)
        {
        }
        ...
        public override void Draw(float time, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture, destination, SourceRectangle, Color, 0, origin, SpriteEffects.None, LayerDepth);
        }
    }
}
