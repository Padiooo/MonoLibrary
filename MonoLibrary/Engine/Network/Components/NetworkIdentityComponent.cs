...
public class NetworkIdentityComponent : IComponent, INetVariable
{
    ...
    private readonly List<NetworkComponent> _networkComponents = [];

    private readonly Dictionary<int, ILocalInvoker> _invokers = [];
    private readonly List<ISerializableCommand> _calls = [];
    ...
    private readonly struct Invoker : IInvokable, ILocalInvoker
    {
        ...
        private readonly struct CallMessage(int methodHash) : ISerializableCommand
        {
            private readonly int methodHash = methodHash;
        ...
        where T : struct
    {
        ...
        private readonly struct CallMessage(int methodHash, T data) : ISerializableCommand
        {
            private readonly int methodHash = methodHash;
