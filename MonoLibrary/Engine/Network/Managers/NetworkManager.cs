...
namespace MonoLibrary.Engine.Network.Managers
{
    public abstract class NetworkManager : INetworkManager, IUpdaterService
    {
        ...
        protected readonly SortedList<int, NetworkIdentityComponent> NetworkIdentityComponents = new();
        protected readonly SortedSet<int> DirtyIdentities = new();

        protected readonly Dictionary<NetPeer, NetworkIdentity> PeerToIdentity = new();
        protected readonly Dictionary<NetworkIdentity, NetPeer> IdentityToPeer = new();
